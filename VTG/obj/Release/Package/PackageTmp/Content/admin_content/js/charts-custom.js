...
$(document).ready(function () {
    ...
    var barChartExample = new Chart(BARCHARTEXMPLE, {
        type: 'bar',
        data: {
            labels: ['other',reagionsnames[0], reagionsnames[1], reagionsnames[2], reagionsnames[3], reagionsnames[4]],
            datasets: [
                {
                    label: "reagion and frequency",
                    backgroundColor: [
                        'rgba(51, 179, 90, 0.6)',
                        'rgba(51, 179, 90, 0.6)',
                        'rgba(51, 179, 90, 0.6)',
                    ...
                    borderWidth: 1,
                    data: [0,reagioncount[0], reagioncount[1], reagioncount[2], reagioncount[3], reagioncount[4]],
                }
